...
public class RUShrubFeatures {
    public static final Map<ResourceKey<Biome>, ShrubGroup> MAP = Map.ofEntries(
        ...
        group(AUTUMNAL_MAPLE_FOREST, 1, entry(MAPLE_NATURAL_SET, 2), entry(RED_MAPLE_NATURAL_SET, 4), entry(ORANGE_MAPLE_NATURAL_SET, 4), entry(SILVER_BIRCH_NATURAL_SET, 4)),
        ...
        group(BOREAL_TAIGA, 1, entry(LARCH_NATURAL_SET, 3), entry(GOLDEN_LARCH_NATURAL_SET, 1)),
        group(CHALK_CLIFFS, 1, FLOWERING_NATURAL_SET),
        group(COLD_BOREAL_TAIGA, 1, LARCH_NATURAL_SET),
        group(COLD_DECIDUOUS_FOREST, 1, SPRUCE_NATURAL_SET),
        ...
        group(GOLDEN_BOREAL_TAIGA, 1, entry(LARCH_NATURAL_SET, 1), entry(GOLDEN_LARCH_NATURAL_SET, 3)),
        ...
        group(MOUNTAINS, 1, PINE_NATURAL_SET),
        ...
        group(PUMPKIN_FIELDS, 1, entry(MAPLE_NATURAL_SET, 2), entry(RED_MAPLE_NATURAL_SET, 4), entry(ORANGE_MAPLE_NATURAL_SET, 4), entry(SILVER_BIRCH_NATURAL_SET, 4)),
        ...
        group(TEMPERATE_GROVE, 1, entry(OAK_NATURAL_SET, 3), entry(BIRCH_NATURAL_SET, 2)),
    ...
    public static void bootstrapPlaced(BootstrapContext<PlacedFeature> context) {
        for (ShrubGroup group : MAP.values()) {
            register(context, group.placed(), placement(group.count(), Heightmap.Types.MOTION_BLOCKING_NO_LEAVES).filter(group.getFirstSet().getShrub()));
        }
    }
