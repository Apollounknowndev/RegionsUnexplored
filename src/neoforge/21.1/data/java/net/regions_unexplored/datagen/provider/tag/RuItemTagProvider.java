...
public class RuItemTagProvider extends ItemTagsProvider {
    ...
    public RuItemTagProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries, CompletableFuture<TagLookup<Block>> blockTags, @Nullable ExistingFileHelper existingFileHelper) {
        super(output, registries, blockTags, RegionsUnexplored.MOD_ID, existingFileHelper);
    }
