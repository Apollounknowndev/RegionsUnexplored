...
public class RuAquaticPlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        final Holder<ConfiguredFeature<?, ?>> JUNGLE_AQUATIC = featureGetter.getOrThrow(RuAquaticFeatures.JUNGLE_AQUATIC);
        final Holder<ConfiguredFeature<?, ?>> PALM_AQUATIC = featureGetter.getOrThrow(RuAquaticFeatures.PALM_AQUATIC);
