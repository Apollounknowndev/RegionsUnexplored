...
public class RuMiscOverworldPlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        var mossPatchWithWater = getter.getOrThrow(RuMiscOverworldFeatures.MOSS_PATCH_WITH_WATER);
        ...
        register(context, RuMiscOverworldPlacements.FALLEN_OAK_SPARSE, fallenOak, surfaceSpread(0.16, Heightmap.Types.OCEAN_FLOOR, Blocks.BIRCH_SAPLING));
        register(context, RuMiscOverworldPlacements.FALLEN_OAK_DENSE, fallenOak, surfaceSpread(0.5, Heightmap.Types.OCEAN_FLOOR, Blocks.BIRCH_SAPLING));
        ...
        register(context, RuMiscOverworldPlacements.MOSS_PATCH_WITH_WATER, mossPatchWithWater, CountPlacement.of(1), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.solid(), BlockPredicate.ONLY_IN_AIR_PREDICATE, 12), RandomOffsetPlacement.vertical(ConstantInt.of(1)), BiomeFilter.biome());
        register(context, RuMiscOverworldPlacements.MOSS_PATCH_WITH_WATER_UNCOMMON, mossPatchWithWater, RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.solid(), BlockPredicate.ONLY_IN_AIR_PREDICATE, 12), RandomOffsetPlacement.vertical(ConstantInt.of(1)), BiomeFilter.biome());
        ...
        register(context, RuMiscOverworldPlacements.ROCK_GROUP_ICY_HEIGHTS, surfaceSpread(1, Heightmap.Types.WORLD_SURFACE_WG));
