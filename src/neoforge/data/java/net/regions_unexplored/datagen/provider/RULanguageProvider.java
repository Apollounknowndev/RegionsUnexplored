...
public class RULanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        for (var boat : RUEntityTypes.BOATS.entrySet()) {
            this.add(boat.getValue().get(), capitalizeString(filterItemLang(boat.getKey().getBoat())));
        }
        for (var boat : RUEntityTypes.CHEST_BOATS.entrySet()) {
            this.add(boat.getValue().get(), filterChestBoatLang(boat.getKey().getChestBoat()));
        }
