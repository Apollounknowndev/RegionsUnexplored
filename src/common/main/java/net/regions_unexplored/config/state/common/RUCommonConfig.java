...
public class RUCommonConfig {
	...
	public static class VanillaChanges {
		public static final Map<String, String> TOGGLES = Map.ofEntries(
			...
			entry("forest_fancy_oaks", "Fancy oak tree will generate more frequently in Forests."),
			entry("forest_flowers", "RU's tall flowers will generate in forested biomes."),
			entry("jungle_bamboo_trees", "Bamboo trees will rarely generate in Jungles."),
			entry("jungle_elephant_ears", "Elephant Ears will generate in Jungles."),
			entry("jungle_hibiscuses", "Hibiscuses will generate in Jungles."),
			entry("mangrove_flowering_lilies", "Flowering Lily Pads will generate in Mangrove Swamps."),
			entry("oak_taller_trees", "Regular oak trees generate 2-3 blocks taller."),
			entry("plains_bushes", "Small bushes will generate in Plains."),
			entry("savanna_bushes", "Small bushes will generate in Savannas."),
			entry("snowy_frozen_grass", "Frozen Grass will generate in snowy biomes."),
